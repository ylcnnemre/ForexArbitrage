...
public class Cadcur {
    ...
    static String eururl="https://api.exchangeratesapi.io/latest?base=CAD";
	static double[] dizi=new double[5];
	static HttpURLConnection baglanti;
	public static double[] oku () throws MalformedURLException, IOException
	{
